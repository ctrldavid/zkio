...
(function() {
  var ASPECT, FAR, HEIGHT, NEAR, Point, PointSpread, VIEW_ANGLE, WIDTH, ambientLight, bbox, camera, cell, cx, cy, directionalLight, draw, edge, fgeometry, floor, fmat, fobject, fvert0, fvert1, fvert2, fvert3, geometry, halfedge, height, index, mat, material, object, pointLight, pointLightx, points, r, renderer, result, scene, t, texture, uv0, uv1, uvs, uvx, vert0, vert1, vert2, vert3, voronoi, width, x, z, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
